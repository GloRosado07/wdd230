...
let nextdayList = [dayNum + 1, dayNum + 2, dayNum + 3];
...
//5 days forecast
const apiURLforecast = 'https://api.openweathermap.org/data/2.5/forecast?id=3530103&units=imperial&appid=e1c9515f8287f6f2048c068c780f63aa';
